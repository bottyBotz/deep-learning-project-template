...
parser = configlib.add_parser("PROJECTNAME configs")
...
parser.add_argument('--continue_epoch', default=-1, type=int, help='Set to -1 to disallow training from most recent epoch. Set to epoch # to continue training.')
